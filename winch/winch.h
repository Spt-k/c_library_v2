...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_PROTOCOL_VERSION, MAVLINK_MESSAGE_INFO_WINCH_DC_PWR, MAVLINK_MESSAGE_INFO_WINCH_MOTOR_SWITCH, MAVLINK_MESSAGE_INFO_WINCH_MOTOR_MAX_I, MAVLINK_MESSAGE_INFO_WINCH_TELEM, MAVLINK_MESSAGE_INFO_WINCH_MOTOR_ALT}
# define MAVLINK_MESSAGE_NAMES {{ "HEARTBEAT", 0 }, { "PROTOCOL_VERSION", 300 }, { "WINCH_DC_PWR", 52500 }, { "WINCH_MOTOR_ALT", 52504 }, { "WINCH_MOTOR_MAX_I", 52502 }, { "WINCH_MOTOR_SWITCH", 52501 }, { "WINCH_TELEM", 52503 }}
